...
#define MENUWIDTH 250.0f
#define iPAD_MENUWIDTH 340.0f

#define SHADOWRADIOUS 5.0f
#define SHADOWOPACITY 0.75f
#define ANIMATIONFACTOR 3.0f
#define DEFAULTDURATION 0.2f
#define MAXDURATION 0.4f
...
- (void)setDefaultSettings {
    ...
    self.shadowRadius = SHADOWRADIOUS;
    self.shadowOpacity = SHADOWOPACITY;
    self.shadowColor = [UIColor blackColor];
    self.menuSlideAnimationFactor = ANIMATIONFACTOR;
    self.shadowEnabled = YES;
    self.menuAnimationDefaultDuration = DEFAULTDURATION;
    self.menuAnimationMaxDuration = MAXDURATION;
...
- (void) handlePan:(UIPanGestureRecognizer *)recognizer {
	...
	if(recognizer.state == UIGestureRecognizerStateBegan) {
        ...
        AppDelegate *app=(AppDelegate*)[UIApplication sharedApplication].delegate;
        SideMenuViewController *mSideMenu= (SideMenuViewController *)app.leftSideMenuViewController;
        mSideMenu.menuTable .userInteractionEnabled=NO;
	}
...
- (void) handleRightPan:(UIPanGestureRecognizer *)recognizer {
    ...
    if(recognizer.state == UIGestureRecognizerStateEnded) {
        ...
        AppDelegate *app=(AppDelegate*)[UIApplication sharedApplication].delegate;
        SideMenuViewController *mSideMenu= (SideMenuViewController *)app.leftSideMenuViewController;
        mSideMenu.menuTable .userInteractionEnabled=YES;
